...
@Component({
  selector: 'app-delete-detail-plan',
...
export class DeleteDetailPlanComponent implements ICellRendererAngularComp {
  ...
  onclick() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.service.deleteDetailPlan(this.params.node.data.id).subscribe((res) => {
        })
