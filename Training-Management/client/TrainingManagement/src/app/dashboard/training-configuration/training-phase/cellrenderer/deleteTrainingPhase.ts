...
@Component({
    selector: 'app-delete-TrainingPhase',
...
export class DeleteTrainingPhaseComponent implements ICellRendererAngularComp {
    ...
    onclick() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                this.service.deleteByPhaseId(this.params.value).subscribe((res) => {
                })
